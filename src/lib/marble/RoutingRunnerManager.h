...
Q_SIGNALS:
     ...
     */
    void routeRetrieved( const Route &route, const RoutingRunnerPlugin &factory );
...
private:
    Q_PRIVATE_SLOT( d, void addRoutingResult( const Route &route, const RoutingRunnerPlugin &factory ) )
